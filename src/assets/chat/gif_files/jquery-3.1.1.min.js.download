...
(function ($) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function (element, options) {
      ...
      if (
        this.$element.find(".input-append") ||
      ...
      this.viewMode =
        options.viewMode || this.$element.data("date-viewmode") || 0;
    ...
    place: function () {
      ...
      var offset = this.component
        ...
        : this.$element.offset();
      this.width = this.component
        ? this.component.outerWidth()
    ...
    fillDate: function () {
      ...
      var startYear =
        typeof this.startDate === "object"
          ...
          : -Infinity;
      var startMonth =
        typeof this.startDate === "object" ? this.startDate.getUTCMonth() : -1;
      var endYear =
        typeof this.endDate === "object"
          ? this.endDate.getUTCFullYear()
          : Infinity;
      var endMonth =
        typeof this.endDate === "object" ? this.endDate.getUTCMonth() : 12;
      this.widget
    ...
    _compileFormat: function () {
      ...
      while ((match = formatComponent.exec(str))) {
        ...
        if (component in dateFormatComponents) {
          ...
          components.push(
            "\\s*" + dateFormatComponents[component].getPattern(this) + "\\s*"
          );
          mask.push({
            pattern: new RegExp(
      ...
      if (this.pickDate && this.pickTime) {
        this.widget.on("click.togglePicker", ".accordion-toggle", function (e) {
          ...
          if (expanded && expanded.length) {
            ...
            self.$element
              .find(".add-on i")
              .toggleClass(self.timeIcon + " " + self.dateIcon);
          }
        });
      }
      if (this.isInput) {
...
!(function (t) {
  (t.Loadingdotdotdot = function (o, e) {
    var d = this;
    (d.$el = t(o)),
      d.$el.data("Loadingdotdotdot", d),
      (d.dotItUp = function (t, o) {
        t.text().length == o ? t.text("") : t.append(".");
      }),
      (d.stopInterval = function () {
        clearInterval(d.theInterval);
      }),
      (d.init = function () {
        ("undefined" != typeof speed && null !== speed) || (speed = 300),
          ("undefined" != typeof maxDots && null !== maxDots) || (maxDots = 3),
          (d.speed = speed),
          (d.maxDots = maxDots),
          (d.options = t.extend({}, t.Loadingdotdotdot.defaultOptions, e)),
          d.$el.html("<span>" + d.options.word + "<em></em></span>"),
          (d.$dots = d.$el.find("em")),
          (d.$loadingText = d.$el.find("span")),
          d.$el.css("position", "relative"),
          d.$loadingText.css({
            position: "absolute",
            top: d.$el.outerHeight() / 2 - d.$loadingText.outerHeight() / 2,
            left: d.$el.width() / 2 - d.$loadingText.width() / 2,
          }),
          (d.theInterval = setInterval(
            d.dotItUp,
            d.options.speed,
            d.$dots,
            d.options.maxDots
    ...
    (t.Loadingdotdotdot.defaultOptions = {
      speed: 300,
      maxDots: 3,
      word: "Loading",
    }),
    (t.fn.Loadingdotdotdot = function (o) {
      if ("string" != typeof o)
        return this.each(function () {
          new t.Loadingdotdotdot(this, o);
        });
      var e = t(this).data("Loadingdotdotdot");
      e && e.stopInterval();
    });
})(jQuery);
  ...
  (c.VERSION = "2.2.0"),
    ...
    (c.prototype.render = function () {
      ...
      c.addClass("toggle-on"),
        ...
        this.$toggle.css({ width: "20px", height: "20px" }),
        this.options.height &&
