          ...
          (t.prototype.decode = function (t) {
            ...
            for (
              var e = this._getPaddingLength(t),
                n = t.length - e,
                i = new Uint8Array(this.maxDecodedLength(n)),
                r = 0,
                s = 0,
                o = 0,
                a = 0,
              ...
              (a = this._decodeChar(t.charCodeAt(s + 0))),
                (c = this._decodeChar(t.charCodeAt(s + 1))),
                (h = this._decodeChar(t.charCodeAt(s + 2))),
                (u = this._decodeChar(t.charCodeAt(s + 3))),
                (i[r++] = (a << 2) | (c >>> 4)),
                (i[r++] = (c << 4) | (h >>> 2)),
                (i[r++] = (h << 6) | u),
                (o |= 256 & a),
            ...
            if (
              (s < n - 1 &&
                ((a = this._decodeChar(t.charCodeAt(s))),
                (c = this._decodeChar(t.charCodeAt(s + 1))),
                (i[r++] = (a << 2) | (c >>> 4)),
                (o |= 256 & a),
                (o |= 256 & c)),
    ...
    function (t, e, n) {
      ...
      var h,
        u = function (t) {
          ...
          let n;
          return (
            e.fullUrl ? (n = e.fullUrl) : e.path && (n = c.baseUrl + e.path),
            n ? "See: " + n : ""
          );
        };
      !(function (t) {
              ...
              if (200 === s.status) {
                ...
                try {
                  ...
                  r(
                    new y(
                      200,
                      `JSON returned from ${i.toString()} endpoint was invalid, yet status code was 200. Data was: ${
                        s.responseText
                      }`
                    ),
                    null
                ...
                r(
                  new y(
                    s.status,
                    `Unable to retrieve auth string from ${i.toString()} endpoint - received status: ${
                      s.status
                    } from ${n.endpoint}. ${t}`
                  ),
                  null
      ...
      function N(t, ...e) {
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          for (var r in i)
            i[r] && i[r].constructor && i[r].constructor === Object
              ? (t[r] = N(t[r] || {}, i[r]))
              : (t[r] = i[r]);
        }
        return t;
      ...
      function $(t) {
        return (
          (e = function (t) {
            return (
              "object" == typeof t && (t = G(t)),
              encodeURIComponent(((e = t.toString()), x(E(e))))
            );
            var e;
          }),
          (n = {}),
      ...
      var V = new (class {
        ...
        Y = function (t, e, n, i, r) {
          (void 0 === n.headers && null == n.headersProvider) ||
            V.warn(
              `To send headers with the ${i.toString()} request, you must use AJAX, rather than JSONP.`
            );
      ...
      class Q {
        ...
        send(t) {
          ...
          i.insertBefore(e.script, i.firstChild),
            e.errorScript &&
              i.insertBefore(e.errorScript, e.script.nextSibling);
        }
        cleanup() {
          this.script &&
      ...
      class st {
        ...
        add(t, e, n) {
          ...
          (this._callbacks[i] = this._callbacks[i] || []),
            this._callbacks[i].push({ fn: e, context: n });
        }
        remove(t, e, n) {
          if (t || e || n) {
      ...
      class ct extends at {
        ...
        connect() {
          ...
          return (
            this.bindListeners(),
            V.debug("Connecting", { transport: this.name, url: t }),
      ...
      class _t {
        ...
        createConnection(t, e, n, i) {
          i = N({}, i, { activityTimeout: this.pingDelay });
          var r = this.transport.createConnection(t, e, n, i),
            ...
            a = (t) => {
              if ((r.unbind("closed", a), 1002 === t.code || 1003 === t.code))
      ...
      class Tt extends at {
        ...
        send_event(t, e, n) {
          ...
          return (
            n && (i.channel = n),
            V.debug("Event sent", i),
            this.send(Ct.encodeMessage(i))
          );
        }
        ping() {
      ...
      class Pt {
        ...
        bindListeners() {
          (this.onMessage = (t) => {
            ...
            try {
              ...
              return (
                this.finish("error", { error: t }), void this.transport.close()
              );
            }
            "connected" === e.action
        ...
        finish(t, e) {
          this.callback(N({ transport: this.transport, action: t }, e));
        }
      }
      class Et {
        constructor(t, e) {
        ...
        send(t, e) {
          this.timeline.isEmpty() ||
            this.timeline.send(ue.TimelineTransport.getAgent(this, t), e);
        }
      }
      class Ot extends at {
        constructor(t, e) {
                ...
                ? ((this.subscriptionPending = !1),
                  ...
                  this.emit(
                    ...
                    Object.assign(
                      ...
                      t instanceof y ? { status: t.status } : {}
                    )
                  ))
      ...
      class jt extends xt {
        ...
        handleEncryptedEvent(t, e) {
          ...
          if (i.length < this.nacl.secretbox.nonceLength)
            return void V.error(
              `Expected encrypted event nonce length to be ${this.nacl.secretbox.nonceLength}, got: ${i.length}`
            );
            ...
            return (
              ...
              void this.authorize(this.pusher.connection.socket_id, (e, s) => {
                e
                  ...
                  : ((r = this.nacl.secretbox.open(n, i, this.key)),
                    null !== r
      ...
      class Nt extends at {
        constructor(t, e) {
          ...
          n.bind("online", () => {
            this.timeline.info({ netinfo: "online" }),
              ("connecting" !== this.state && "unavailable" !== this.state) ||
                this.retryIn(0);
          }),
            n.bind("offline", () => {
        ...
        startConnecting() {
          var t = (e, n) => {
            e
              ...
              : "error" === n.action
              ? (this.emit("error", { type: "HandshakeError", error: n.error }),
        ...
        sendActivityCheck() {
          this.stopActivityCheck(),
            ...
            (this.activityTimer = new I(this.options.pongTimeout, () => {
        ...
        resetActivityCheck() {
          this.stopActivityCheck(),
            this.connection &&
              ...
              (this.activityTimer = new I(this.activityTimeout, () => {
        ...
        buildErrorCallbacks() {
          let t = (t) => (e) => {
            e.error &&
              this.emit("error", { type: "WebSocketError", error: e.error }),
              t(e);
          };
          return {
            tls_only: t(() => {
            ...
            this.channels[t] ||
              (this.channels[t] = (function (t, e) {
                if (0 === t.indexOf("private-encrypted-")) {
                  if (e.config.nacl)
                    return Ut.createEncryptedChannel(t, e, e.config.nacl);
                  let n =
                ...
                if (0 === t.indexOf("private-"))
                  return Ut.createPrivateChannel(t, e);
                if (0 === t.indexOf("presence-"))
                  return Ut.createPresenceChannel(t, e);
                if (0 === t.indexOf("#"))
                  ...
                  i < n.length
                    ? (r &&
                      ...
                      (s = this.tryStrategy(
                        n[i],
                        t,
                        { timeout: r, failFast: this.failFast },
                        o
                      )))
                    : e(!0));
            };
        ...
        tryStrategy(t, e, n, i) {
          ...
          return (
            ...
            (s = t.connect(e, function (t, e) {
              (t && r && r.isRunning() && !n.failFast) ||
                (r && r.ensureAborted(), i(t, e));
            })),
            {
              abort: function () {
        ...
        connect(t, e) {
          ...
          if (i && i.timestamp + this.ttl >= j.now()) {
            ...
            s &&
              ...
              r.push(
                new zt([s], { timeout: 2 * i.latency + 1e3, failFast: !0 })
              ));
          }
          var o = j.now(),
      ...
      var Yt = function (t, e, n) {
          ...
          var s,
            ...
            u = new Mt({ minPingDelay: 1e4, maxPingDelay: t.activityTimeout }),
            l = new Mt({
              lives: 2,
              minPingDelay: 1e4,
            ...
            C = new zt(
              [new Wt(Vt(_), new qt([_, new $t(k, { delay: 4e3 })]), k)],
              h
            ),
            T = new Wt(Vt(C), C, S);
          return (
            (s = e.useTLS
              ? new qt([y, new $t(T, { delay: 2e3 })])
              : new qt([
                  y,
                  new $t(w, { delay: 2e3 }),
                  new $t(T, { delay: 5e3 }),
      ...
      class Kt extends at {
        ...
        start(t) {
          (this.position = 0),
            ...
            ue.addUnloadListener(this.unloader),
        ...
        close() {
          this.unloader &&
            (ue.removeUnloadListener(this.unloader), (this.unloader = null)),
      ...
      var re,
        se = class {
          ...
          onClose(t, e, n) {
            this.closeStream(),
              (this.readyState = te.CLOSED),
              this.onclose && this.onclose({ code: t, reason: e, wasClean: n });
          }
          onChunk(t) {
            var e;
            if (200 === t.status)
              switch (
                (this.readyState === te.OPEN && this.onActivity(),
                t.data.slice(0, 1))
              ) {
                case "o":
          ...
          openStream() {
            (this.stream = ue.createSocketRequest(
              "POST",
              ne(this.hooks.getReceiveURL(this.location, this.session))
            )),
      ...
      class de {
        ...
        log(t, e) {
          t <= this.options.level &&
            (this.events.push(N({}, e, { timestamp: j.now() })),
            this.options.limit &&
      ...
      var ve = function (t, e, n, i, r, s) {
          ...
          return (
            !(
              (t.enabledTransports && -1 === U(t.enabledTransports, e)) ||
              (t.disabledTransports && -1 !== U(t.disabledTransports, e))
            )
              ? ((r = Object.assign(
                  { ignoreNullOrigin: t.ignoreNullOrigin },
                  r
                )),
                (o = new pe(e, i, s ? s.getAssistant(a) : a, r)))
              : (o = me),
            o
          );
        },
      ...
      var be = (t) => {
        if (void 0 === ue.getAuthorizers()[t.transport])
      ...
      function Ce(t) {
        const e = Object.assign(
          Object.assign({}, s.userAuthentication),
        ...
        const n = (function (t, e) {
          ...
          return (
            "channelAuthorization" in t
              ? (n = Object.assign(
                  Object.assign({}, s.channelAuthorization),
      ...
      class Oe extends at {
        constructor(t) {
          super(function (t, e) {
            ...
            (this._onAuthorize = (t, e) => {
              if (t)
                return (
                  V.warn("Error during signin: " + t), void this._cleanup()
                );
        ...
        _onSigninSuccess(t) {
          try {
            ...
            return (
              V.error("Failed parsing user data after signin: " + t.user_data),
              void this._cleanup()
            );
          }
        ...
        _subscribeChannels() {
          (this.serverToUserChannel = new Ot(
        ...
        _newSigninPromiseIfNeeded() {
          ...
          const { promise: t, resolve: e, reject: n } = Ee();
          t.done = !1;
          const i = () => {
            t.done = !0;
          };
      ...
      class xe {
        static ready() {
          xe.isReady = !0;
          for (var t = 0, e = xe.instances.length; t < e; t++)
            xe.instances[t].connect();
        }
        static getClientFeatures() {
          return z(
            X({ ws: ue.Transports.ws }, function (t) {
              return t.isSupported({});
            })
          );
        }
        constructor(t, e) {
          !(function (t) {
            ...
            (this.config = (function (t, e) {
              let n = {
                ...
                unavailableTimeout:
                  t.unavailableTimeout || s.unavailableTimeout,
            ...
            (this.channels = Ut.createChannels()),
            (this.global_emitter = new at()),
            (this.sessionID = ue.randomInt(1e9)),
            (this.timeline = new de(this.key, this.sessionID, {
            ...
            this.config.enableStats &&
              (this.timelineSender = Ut.createTimelineSender(this.timeline, {
          ...
          (this.connection = Ut.createConnectionManager(this.key, {
            ...
            xe.instances.push(this),
            this.timeline.info({ instances: xe.instances.length }),
            (this.user = new Oe(this)),
            xe.isReady && this.connect();
        }
        channel(t) {
        ...
        unsubscribe(t) {
          ...
          e && e.subscriptionPending
            ...
            : (e = this.channels.remove(t)) && e.subscribed && e.unsubscribe();
        }
        send_event(t, e, n) {
      ...
      (xe.instances = []),
        ...
        (xe.logToConsole = !1),
        (xe.Runtime = ue),
        (xe.ScriptReceivers = ue.ScriptReceivers),
